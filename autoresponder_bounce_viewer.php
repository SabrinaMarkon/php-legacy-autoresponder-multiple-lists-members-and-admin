...
<tr><td align="center" colspan="2"><br><a href="autoresponder_bounce_viewer.php">BACK TO YOUR BOUNCE VIEWER</a></td></tr>
</table>
<!-- END PAGE CONTENT //-->
<?php
include "footer.php";
...
<?php
$q = "select * from pages where name='Members Area - Autoresponder Bounced Email Viewer Page'";
$r = mysql_query($q);
...
<?php
$q = "select * from autoresponders_prospects where userid=\"$userid\" and bounces>0 order by bounces desc,bouncelastdate desc";
$r = mysql_query($q);
$rows = mysql_num_rows($r);
if ($rows < 1)
{
echo "None of your prospects' email addresses have bounced in response to your AutoResponder messages yet.";
}
if ($rows > 0)
{
################################################################
...
<tr class="sabrinatrlight"><td colspan="14" align="center"><div style="width:800px;overflow:auto;" align="center"><?php echo $pagetext ?></div></td></tr>
...
<td align="center">Last Bounce</td>
<td align="center">Last Bounce Error</td>
<td align="center">Vacation (from bouncing)</td>
<td align="center">Vacation Date</td>
...
<tr class="sabrinatrdark"><td colspan="14"></td></tr>
<?php
	}
?>
</table>
